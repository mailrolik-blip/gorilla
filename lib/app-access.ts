...
const roleDefinitions: Record<PlatformRole, RoleDefinition> = {
  USER: {
    ...
    cabinetDescription:
      'Основной кабинет пользователя: дети, записи на тренировки, заявки в команду и бронирования аренды.',
    adminDescription: null,
    allowedActions: [
      'Видит только свои данные, своих детей и собственные пользовательские сценарии.',
