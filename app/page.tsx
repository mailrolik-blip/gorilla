  ...
  return (
    <main className="homepage-school-shell relative min-h-screen overflow-x-clip bg-[color:var(--gh-bg)] text-[color:var(--gh-text)]">
      <div className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_14%_8%,rgba(53,102,143,0.3),transparent_24%),radial-gradient(circle_at_84%_16%,rgba(245,158,11,0.12),transparent_18%),radial-gradient(circle_at_50%_108%,rgba(74,132,169,0.16),transparent_30%)]" />
        ...
        <div className="absolute inset-0 opacity-[0.16] [background-image:linear-gradient(158deg,transparent_0%,rgba(92,139,171,0.1)_44%,transparent_45%),linear-gradient(11deg,transparent_0%,rgba(245,158,11,0.05)_64%,transparent_65%)]" />
      </div>
